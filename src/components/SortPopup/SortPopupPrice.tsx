...
import TriangleSvg from "../../config/assets/svg/TriangleSvg";
...
const SortPopupPrice = () => {
    ...
    const minInitialState = String(minPrice);
    ...
    const toggleVisiblePopup = useCallback(() => {
        setVisiblePopup(!visiblePopup);
    }, [visiblePopup]);

    const handleOutsideClick = useCallback(() => setVisiblePopup(false), []);
